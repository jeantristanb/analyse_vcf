...
def ConcatenerDeuxVCF(File1, File2, FileOut, TGZ) :
    ...
    while Balise :
      if Cmt ==1 :
         ...
         ListeInfoNullPop1=["./."]*len(Info1[2])
         ListeInfoNullPop2=["./."]*len(Info2[2])
      if Balise1==False and Balise2==False :
         Balise=False
         print "end of File "
      elif Balise1==False :
          (Balise2, Chro2, Pos2, Info2)=GetInfoVCF(Lire2)
          if Balise2==True :
             (BaliseVCFPrint, LigneVCF)=ConcatenerLigneVCF(Chro2,Pos2, (Info2[0] ,Info2[1],ListeInfoNullPop1),Info2)
             if BaliseVCFPrint :
               Ecrire.write(LigneVCF+"\n")
      elif Balise2==False :
          (Balise1, Chro1, Pos1, Info1)=GetInfoVCF(Lire1)
          if Balise1==True :
             (BaliseVCFPrint, LigneVCF)=ConcatenerLigneVCF(Chro1,Pos1,Info1,(Info1[0],Info1[1],ListeInfoNullPop2))
             if BaliseVCFPrint :
               Ecrire.write(LigneVCF+"\n")
      elif Chro1!=Chro2 :
