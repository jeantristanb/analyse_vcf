...
def RecupereDiv(ListeVCF,PosVcfIndPop, TailleFenetre,MinFreqBon,IsGZ, EnteteSortie, NomEnteteDtaj, ChaineEnteteFst, ChaineEnteteLD):
...
RecupereDiv(ListeFileVCF,InfoNomPosPop,SizeWindows,MinFreqBon,EstGZ, EnteteSortie, ChaineEntete, ChaineEnteteFst, ChaineEnteteLD)
