           ...
           for Pop2 in VecteurNbPop[(Pop+1)::]:
               ...
               if NbIndNonCouvert[Pop]==0 and NbIndNonCouvert[Pop2]==0:
                     ...
                     if NbInd0>1 :
                        ...
                        # Old Method : (HT2Pops - (HsPop[Pop]*NbIndByPop[Pop] + HsPop[Pop2]*NbIndByPop[Pop2])/(NbIndByPop[Pop]+NbIndByPop[Pop2]))/HT2Pops
                        #if FstPop[Pop][Pop2]<10**-4 and FstPop[Pop][Pop2]>-10**-4 :
                           #print FstPop[Pop][Pop2],Pop,Pop2, HT2Pops, HsPop[Pop], HsPop[Pop2], Freq2Pop,NbIndByPop[Pop2],NbIndByPop[Pop]
                        #   FstPop[Pop][Pop2]=0
                        #if FstPop[Pop][Pop2]>1 or FstPop[Pop][Pop2]<0:
                        #   print FstPop[Pop][Pop2], HT2Pops, HsPop[Pop], HsPop[Pop2], Freq2Pop,NbIndByPop[Pop2],NbIndByPop[Pop]
                        #   sys.exit("Fst> 0 or Fst < 1")
                     else :
                        FstPop[Pop][Pop2]=-1
                        PoidFst[Pop][Pop2]=-1
                        FstPopCresko[Pop][Pop2]=-1
