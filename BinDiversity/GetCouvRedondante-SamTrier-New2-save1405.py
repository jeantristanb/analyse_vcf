              ...
              if CmtBon==0:
               ...
               if (MaxPos >= PosI2+PasPourSave and MinPos >= PosI2+PasPourSave) or Chro!=splitligne[2]:
                 if BalPrintAll :
                    ...
                    EcrireListeSnp(ListeNonRed1, ListeRed1, PosI1, PasPourSave, Chro, InfoPos, EcrireSortie)
                    EcrireListeSnp(ListeNonRed2, ListeRed2, PosI2, PasPourSave, Chro, InfoPos, EcrireSortie)
                 PosI1=MinPos
                 PosI2=PosI1+PasPourSave
                 Chro=splitligne[2]
